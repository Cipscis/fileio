...
![Build and deploy status badge](https://github.com/cipscis/fileio/actions/workflows/build-and-deploy.yml/badge.svg)

## Install

Run `npm install github:cipscis/fileio#semver:1.x`

## Usage

See [FileIO documentation](https://cipscis.github.io/fileio/)
